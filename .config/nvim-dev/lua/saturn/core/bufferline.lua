...
M.setup = function()
  require("saturn.keymappings").load(saturn.builtin.bufferline.keymap)
  ...
  bufferline.setup {
    options = saturn.builtin.bufferline.options,
    highlights = saturn.builtin.bufferline.highlights,
  }

  if saturn.builtin.bufferline.on_config_done then
    saturn.builtin.bufferline.on_config_done()
  end
end
