...
M.setup = function()
  ...
  M.create_winbar()
  navic.setup(saturn.builtin.breadcrumbs.options)

  if saturn.builtin.breadcrumbs.on_config_done then
    saturn.builtin.breadcrumbs.on_config_done()
  end
end
...
local excludes = function()
  return vim.tbl_contains(saturn.builtin.breadcrumbs.winbar_filetype_exclude or {}, vim.bo.filetype)
end
    ...
    vim.api.nvim_create_autocmd(
      { "CursorMoved", "CursorHold", "BufWinEnter", "BufFilePost", "InsertEnter", "BufWritePost", "TabClosed" },
      {
        ...
        callback = function()
          ...
          if not status_ok then
            -- TODO:
            require("saturn.core.breadcrumbs").get_winbar()
          end
        end,
      }
    )
