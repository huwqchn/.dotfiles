...
M.config = function()
  -- require("saturn.basic.keymaps").load(saturn.plugins.bufferline.keymap)
  ...
  bufferline.setup({
    options = saturn.plugins.bufferline.options,
    highlights = saturn.plugins.bufferline.highlights,
  })

  if saturn.plugins.bufferline.on_config_done then
    saturn.plugins.bufferline.on_config_done()
  end
end
