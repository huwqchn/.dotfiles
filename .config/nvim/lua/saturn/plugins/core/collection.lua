return {
  ...
  },
  {
    ...
    dependencies = {
      ...
      "cmp-buffer",
      "cmp-path",
      { "cmp-cmdline", enabled = saturn.enable_extra_plugins },
      { "cmp-cmdline-history", enabled = saturn.enable_extra_plugins },
      { "cmp-emoji", enabled = saturn.enable_extra_plugins },
      { "cmp-nvim-lua", enabled = saturn.enable_extra_plugins },
      { "cmp-tabnine", enabled = saturn.enable_extra_plugins },
      { "copilot-cmp", enabled = saturn.enable_extra_plugins },
    },
  },
