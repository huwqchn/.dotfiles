...
function M.config()
  local dashboard = require "saturn.plugins.core.alpha.dashboard"
  local startify = require "saturn.plugins.core.alpha.startify"
...
local function resolve_config(theme_name)
  ...
  local section = saturn.plugins.core.alpha[theme_name].section
...
local function configure_additional_autocmds()
  ...
  if not saturn.plugins.core.lualine.options.globalstatus then
...
function M.setup()
  ...
  local mode = saturn.plugins.core.alpha.mode
  local config = saturn.plugins.core.alpha[mode].config
