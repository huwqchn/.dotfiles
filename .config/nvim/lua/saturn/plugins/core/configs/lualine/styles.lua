...
function M.update()
  local style = M.get_style(saturn.plugins.core.lualine.style)

  saturn.plugins.core.lualine = vim.tbl_deep_extend("keep", saturn.plugins.core.lualine, style)
  ...
  if theme_supported and template then
    saturn.plugins.core.lualine.options.theme = color_template
  end
end
