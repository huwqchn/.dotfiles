...
local saturn_lsp_utils = require "saturn.plugins.core.lsp.utils"
...
local function resolve_config(server_name, ...)
  local defaults = {
    on_attach = require("saturn.plugins.core.lsp").common_on_attach,
    on_init = require("saturn.plugins.core.lsp").common_on_init,
    on_exit = require("saturn.plugins.core.lsp").common_on_exit,
    capabilities = require("saturn.plugins.core.lsp").common_capabilities(),
  }

  local has_custom_provider, custom_config = pcall(require, "saturn/plugins/core/lsp/providers/" .. server_name)
...
function M.setup(server_name, user_config)
  ...
  local should_auto_install = function(name)
    local installer_settings = saturn.lsp.installer.setup
