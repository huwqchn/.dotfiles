...
function M.config()
  ...
  saturn.plugins.whichkey.mappings["z"] = {
    name = "true-zen",
  ...
  saturn.plugins.whichkey.vmappings["z"] = {
    name = "true-zen",
...
function M.setup()
  ...
  true_zen.setup(saturn.plugins.true_zen)
  if saturn.plugins.true_zen.on_config_done then
    saturn.plugins.true_zen.on_config_done(true_zen)
  end
end
