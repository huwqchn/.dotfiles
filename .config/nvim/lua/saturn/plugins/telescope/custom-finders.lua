...
function M.find_saturn_files(opts)
  opts = opts or {}
  local theme_opts = themes.get_ivy {
    sorting_strategy = "ascending",
    layout_strategy = "bottom_pane",
    prompt_prefix = ">> ",
    prompt_title = "~ Saturn files ~",
    cwd = runtime_dir,
    search_dirs = { base_dir, saturn.plugins.lsp.templates_dir },
  }
  opts = vim.tbl_deep_extend("force", theme_opts, opts)
  builtin.find_files(opts)
end

function M.grep_saturn_files(opts)
  opts = opts or {}
  local theme_opts = themes.get_ivy {
    sorting_strategy = "ascending",
    layout_strategy = "bottom_pane",
    prompt_prefix = ">> ",
    prompt_title = "~ search Saturn ~",
    cwd = runtime_dir,
    search_dirs = { base_dir, saturn.plugins.lsp.templates_dir },
  }
  opts = vim.tbl_deep_extend("force", theme_opts, opts)
...
function M.view_saturn_changelog()
