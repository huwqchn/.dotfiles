{
  ...
  # Add my custom lib, vars, nixpkgs instances, and all the inputs to specialArgs,
  # so that I can use them in all my modules
  ...
  # This is the args for all the haumea modulse in this folder.
  args = { inherit inputs lib mylib myvars genSpecialArgs; };

  # modules for each supported system
  nixosSystems.x86_64-linux = import ./x86_64-linux (args // { system = "x86_64-linux"; });
  darwinSystems.aarch64-darwin = import ./aarch64-darwin (args // { system = "aarch64-darwin"; });
